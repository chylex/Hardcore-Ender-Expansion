...
public final class ItemList{
	...
	public static Item sacred_wand;
	...
	public static void loadItems(){
		...
		register("sacred_wand", sacred_wand = new ItemSacredWand().setMaxStackSize(1).setMaxDamage(860).setNoRepair().setUnlocalizedName("sacredWand").setTextureName("hardcoreenderexpansion:sacred_wand"));
