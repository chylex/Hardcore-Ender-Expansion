...
public enum CharmType{	
	...
	BASIC_AGILITY(2, 0, new CharmRecipe[]{
	...
	BASIC_VIGOR(4, 0, new CharmRecipe[]{
	...
	BASIC_DEFENSE(8, 0, new CharmRecipe[]{
	...
	BASIC_MAGIC(11, 0, new CharmRecipe[]{
	...
	WITCHERY_HARM(14, 0, new CharmRecipe[]{
