...
public enum CharmType{
	...
	BASIC_VOID(new CharmRecipe[]{
		
	}),
	
	EQUALITY(new CharmRecipe[]{
	...
	BLOCKING_REFLECTION(new CharmRecipe[]{
	...
	DIGESTIVE_RECOVER(new CharmRecipe[]{
	...
	DAMAGE_REDIRECTION(new CharmRecipe[]{
	...
	MAGIC_PENETRATION(new CharmRecipe[]{ // TODO check balance
	...
	WITCHERY_DEFENSE(new CharmRecipe[]{
	...
	FALLING_PROTECTION(new CharmRecipe[]{
	...
	CRITICAL_STRIKE(new CharmRecipe[]{
	...
	SECOND_DURABILITY(new CharmRecipe[]{
