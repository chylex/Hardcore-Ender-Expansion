...
public class TileEntityDecompositionTable extends TileEntityAbstractEnergyInventory implements IInventoryInvalidateable{
	...
	protected boolean isWorking(){
		return requiredStardust > 0 && items[1] != null && items[1].getItem() == ItemList.stardust && items[1].stackSize >= requiredStardust;
	}
