...
public final class ItemList{
	...
	public static Item alteration_nexus;
	...
	public static void loadItems(){
		...
		register("alteration_nexus", alteration_nexus = new Item().setUnlocalizedName("alterationNexus").setTextureName("hardcoreenderexpansion:alteration_nexus"));
