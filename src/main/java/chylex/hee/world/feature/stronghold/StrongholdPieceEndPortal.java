...
public class StrongholdPieceEndPortal extends StrongholdPiece{
	public StrongholdPieceEndPortal(){
		...
		addConnection(Facing4.NORTH_NEGZ,8,0,0,connectsWithCorridor);
		addConnection(Facing4.SOUTH_POSZ,8,0,16,connectsWithCorridor);
		addConnection(Facing4.EAST_POSX,16,0,8,connectsWithCorridor);
		addConnection(Facing4.WEST_NEGX,0,0,8,connectsWithCorridor);
		addConnection(Facing4.NORTH_NEGZ,8,6,0,connectsWithCorridor);
		addConnection(Facing4.SOUTH_POSZ,8,6,16,connectsWithCorridor);
		addConnection(Facing4.EAST_POSX,16,6,8,connectsWithCorridor);
		addConnection(Facing4.WEST_NEGX,0,6,8,connectsWithCorridor);
	}
