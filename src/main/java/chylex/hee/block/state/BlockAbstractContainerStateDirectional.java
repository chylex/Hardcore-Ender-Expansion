...
public abstract class BlockAbstractContainerStateDirectional extends BlockAbstractContainerState{
	private IProperty metaProp;
	private Enum[] metaStates;
	
	public BlockAbstractContainerStateDirectional(Material materialIn){
		super(materialIn);
	}
