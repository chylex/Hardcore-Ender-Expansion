...
public final class JsonRenderPatterns{
	public static final JsonRenderPatterns BLOCK_STATE_NORMAL = new JsonRenderPatterns(
		"{'variants':{'normal':{'model':'$0'}}}"
	); // <blockModel>
	
	public static final JsonRenderPatterns BLOCK_CUBE = new JsonRenderPatterns(
		"{'parent':'block/cube_all','textures':{'all':'$0'}}"
	); // blocks/<textureName>
